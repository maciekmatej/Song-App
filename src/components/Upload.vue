    ...
    upload($event) {
      ...
      files.forEach((file) => {
        ...
        task.on('state_changed', (snapshot) => {
          ...
          this.uploads[uploadIndex].icon = 'fas fa-times-circle text-red-400';
        }, async () => {
          const song = {
          ...
          this.uploads[uploadIndex].icon = 'fas fa-check-circle text-green-400';
